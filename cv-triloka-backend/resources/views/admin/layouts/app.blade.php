            ...
            <div class="flex flex-col h-full">
                ...
                <nav class="flex-1 px-4 py-4 space-y-1 overflow-y-auto">
                    ...
                    <a href="{{ route('admin.negotiations.index') }}" 
                       class="flex items-center px-4 py-3 text-sm font-medium rounded-lg {{ request()->routeIs('admin.negotiations.*') ? 'text-white' : 'text-gray-700 hover:bg-gray-100' }}"
                       style="{{ request()->routeIs('admin.negotiations.*') ? 'background-color: #6C5DD3;' : '' }}">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
